...
\end{enumerate}
	...
	\exitem{A largura e o comprimento de um retângulo medem  \( x cm \)  e  \(  \left( x+3 \right) cm \) , respectivamente. Qual é o valor de \textit{x}, para que o perímetro seja:}
...
\begin{respostas}{3}
	...
	\ansitem{a)  \( -2 \) \quad \quad b) 2\quad ~~ c) 1\quad  \quad d) -2\quad \quad e) 2/3}
