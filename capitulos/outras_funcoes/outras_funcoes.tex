...
\end{multicols}
	...
	\item Faça o gráfico das funções do Ex. 2, usando uma planilha eletrônica.
...
\end{multicols}
	...
	\item Faça os gráficos das funções do Ex.1 utilizando uma planilha eletrônica (ou outro programa computacional) 
...
\end{multicols}
	...
	\item Crie uma função par, faça o gráfico e determine o domínio e a imagem.

	\item Crie uma função ímpar, faça o gráfico e determine o domínio e a imagem.
...
\end{multicols}
	...
	\item Faça o gráfico da função periódica:   \( f \left( x \right) = \vert x \vert   \) , para \textit{T = 1}.
